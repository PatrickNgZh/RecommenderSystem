...
class user_collaborative_filtering:
    ...
    def get_user_song_score(self, score_min=85):
        """
        获取 用户-歌曲-评分 数据集
    ...
    def get_neighbors_same_songs(self, user_id, user_neighbors, score_min=85, limit=200):
        """
    ...
    def serialize_algo(self, algoType, score_min=85):
        """
        生成并序列化algo
    ...
    def get_serialize_algo(self, score_min=85):
        """
        获取序列化algo
...
if __name__ == '__main__':
    ...
    print("get neighbors...")
    user_neighbors = user_cf.get_neighbors(algo=algo, user_id=user_id, k=5)
    ...
    # print(all_user_song_score_list)
