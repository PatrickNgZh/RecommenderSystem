...
if __name__ == "__main__":
    ...
    print(user_id_list[1][1][0])
    for i in range(len(user_id_list[1])):
        id=user_id_list[1][i][0]
        try:
            print(user_playlists().get_user_playlists(id, created_playlists_max=max, collected_playlists_max=max,
                                              is_playlists_default=True, is_playlists_created=True,
                                              is_playlists_collected=True))
        except:
            print("fail")
    # print(user_playlists().get_user_playlists(config.user_id, created_playlists_max=5, collected_playlists_max=20,
    #                                          is_playlists_default=True, is_playlists_created=True,
    #                                           is_playlists_collected=True))
